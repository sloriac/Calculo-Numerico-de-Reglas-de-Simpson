"""FastAPI application: thin API layer over the simpson package."""
...
from schemas import ExperimentsResponse, IntegrationRequest, IntegrationResponse, QuadratureNodeResponse, SweepRow
...
app = FastAPI(title="Simpson 3/8 Simple API")
app.add_middleware(
    CORSMiddleware,
